...
if (isset($_GET["view"])) {
  ...
  $sql = "SELECT * FROM gs_employees WHERE emp_id = '" . $id . "' AND country_type = 'Ph'";
  ...
  $sal_details_query = "SELECT * FROM gs_emp_salary WHERE employee_id = '" . $id . "' AND country_type = 'Ph' ORDER BY month_yr DESC";
              ...
              <div class="card">
                <div class="card-body text-center">
                  <div class="row">
                    ...
                    <div class="col-lg-4 p-2">
                      <p class="text-muted mb-0">DATE HIRED</p>
                    ...
                    <div class="col-lg-4 p-2">
                      <p class="text-muted mb-0">TIN No.</p>
                      <h3 class="m-0 mb-1"><?php echo $row['emp_pan']; ?></h3>
                    </div>
                    <div class="col-lg-4 p-2">
                      <p class="text-muted mb-0">SSS No.</p>
                      <h3 class="m-0 mb-1"><?php echo $row['emp_uan']; ?></h3>
                    </div>
                    <div class="col-lg-4 p-2">
                      <p class="text-muted mb-0">PHILIHEALTH No.</p>
