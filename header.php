  ...
  <div class="page">
    <header class="navbar navbar-expand-md navbar-light d-print-none">
      <div class="container-xl">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
              <?php if (isset($_SESSION["user_pp"])) { ?>
                ...
                <img src="./<?php echo $_SESSION["user_pp"]; ?>" class="avatar avatar-sm" />
              <?php } else { ?>
        ...
        <?php if ($_SESSION["user_type"] != 3 && $_SESSION["country_type"] == 'In') { ?>

          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                <li class="nav-item <?php if ($page == "sal_struc") {
                                      echo "active";
                                    } ?>">
                ...
                <li class="nav-item <?php if ($page == "add_payslip") {
                                      echo "active";
                                    } ?>">
                ...
                <li class="nav-item <?php if ($parent_page == "emp") {
                                      echo "active";
                                    } ?> dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item <?php if ($page == "view_emps") {
                                              echo "active";
                                            } ?>" href="./view_emps.php">
                    ...
                    <a class="dropdown-item <?php if ($page == "add_emp") {
                                              echo "active";
                                            } ?>" href="./add_new_emp.php">
                    ...
                    <a class="dropdown-item <?php if ($page == "bulk_sal_slip") {
                                              echo "active";
                                            } ?> text-pink" href="./bulk_sal_slip.php" rel="noopener">
        ...
        <?php } else if ($_SESSION["user_type"] != 3 && $_SESSION["country_type"] == 'Ph') { ?>
          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                <li class="nav-item <?php if ($page == "phsal_struc") {
                                      echo "active";
                                    } ?>">
                  <a class="nav-link" href="./phsal_struc.php">
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/star -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-currency-rupee" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M18 5h-11h3a4 4 0 0 1 0 8h-3l6 6"></path>
