...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password, user_type, user_status FROM ph_users WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password) && $user_status == 1){
                          ...
                          $sqlpp = "SELECT emp_pic FROM ph_employees WHERE emp_id = '".$username."'";
    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark"><img src="./static/GlobalSync.png" height="100" alt=""><span class="text-dark h1 mb-0"> Payroll System</span></a>
        </div>
